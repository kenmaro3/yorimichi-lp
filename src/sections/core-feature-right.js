...
import CoreFeatureThumb from 'assets/test3.PNG';
  ...
  features: [
    {
      ...
      title: '人気の投稿で流行検索',
      text:
        '人気の投稿はユーザからのいいねが一番多かったヨリミチ先。流行の場所にあなたも訪れてみよう。',
    },
    {
      id: 2,
      imgSrc: Secure,
      ...
      title: '周辺の投稿検索',
      text:
        '周辺の投稿はあなたの周りのおすすめのヨリミチ先。あなたも気軽にヨリミチしてみよう。',
    },
  ],
};

export default function CoreFeatureRight() {
  return (
