...
import CoreFeatureThumb from 'assets/test1.PNG';
  ...
  features: [
    {
      id: 1,
      imgSrc: Briefcase,
      altText: 'マップ上で今日のヨリミチを決めよう',
      title: 'マップ上で今日のヨリミチ候補を検索',
      text:
        '誰かのヨリミチを、今日はあなたが再現してみよう。マップ上で誰かのヨリミチを簡単検索。',
    },
    {
      id: 2,
      imgSrc: Secure,
      altText: 'Secure Contents',
      title: '行ってみたい場所をお気に入りに登録',
      text:
        '誰かのヨリミチ先をお気に入りに登録。近くに行った時に「行こうと思ってた場所どこだったっけ」ともう悩まない。',
    },
  ],
};
